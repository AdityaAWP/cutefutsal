...
<head>
    ...
    <title>Tambah Lapangan - Cute Futsal</title>
...
<body class="bg-white font-poppins">
    ...
    <div class="mt-20 px-4 md:px-20 min-h-screen my-10">
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center gap-4 mb-8">
                ...
                <h2 class="text-3xl font-bold text-pink-600">Tambah Lapangan Baru</h2>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_lapangan" id="nama_lapangan"
                                ...
                                placeholder="Contoh: Lapangan A" value="{{ old('nama_lapangan') }}" required>
                            @error('nama_lapangan')
                        ...
                        <div>
                            ...
                            <select name="tipe" id="tipe"
                                ...
                                <option value="Sintetis" {{ old('tipe')=='Sintetis' ? 'selected' : '' }}>Sintetis
                                </option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="spesifikasi" id="spesifikasi" rows="4"
                                class="w-full px-4 py-3 border rounded-lg focus:ring-pink-500 focus:border-pink-500 @error('spesifikasi') border-red-500 @enderror"
                                placeholder="Contoh: Ukuran 20x40m, Rumput sintetis, Lighting LED, Tribun penonton 50 orang">{{ old('spesifikasi') }}</textarea>
                            @error('spesifikasi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div
                                class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-pink-400 transition duration-300">
