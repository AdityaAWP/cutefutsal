...
<body class="bg-gradient-to-br from-pink-200 to-purple-300 min-h-screen flex items-center justify-center px-4">
    ...
    <div class="bg-white shadow-2xl rounded-3xl max-w-md w-full p-8 relative">
        ...
        <h2 class="text-3xl font-extrabold text-center text-gray-800 mb-6">Welcome Back to <span
                class="text-pink-500">CuteFutsal</span> 👋</h2>
        <p class="text-center text-sm text-gray-500 mb-4">Login dulu yuk biar bisa reservasi lapangan & ngerasain
            vibes-nya!</p>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-500">
                Belum punya akun? <a href="{{ route('register') }}"
                    class="text-pink-500 font-medium hover:underline">Registrasi dulu</a>
            </p>
        </div>
    </div>
